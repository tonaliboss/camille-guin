...
interface Props {
  ...
  useThemedFont?: boolean
}

export default function CamoriaFooter({ settings, useThemedFont = false }: Props) {
  ...
  return (
    <footer className="px-5 py-8 mt-4">
      ...
      >
        <p className={cn(
          'font-bold text-[18px] mb-2 leading-tight',
          useThemedFont ? 'font-themed italic' : 'font-lora-italic'
        )}>
